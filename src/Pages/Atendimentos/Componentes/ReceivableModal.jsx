...
// só data (sem hora) -- horário do pagamento não importa nesse MVP
...
// converte "YYYY-MM-DD" pra um ISO datetime fixo (meio-dia, sem timezone
// no payload) -- evita mandar 'Z' pro backend e complicar comparação
// com datetime.utcnow() (naive) lá
